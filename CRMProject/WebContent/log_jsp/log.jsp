...
<link rel="stylesheet" type="text/css" href="../ziyuan/jquery-easyui-1.3.3/themes/default/easyui.css">
<link rel="stylesheet" type="text/css" href="../ziyuan/jquery-easyui-1.3.3/themes/icon.css">
<script type="text/javascript" src="../ziyuan/jquery-easyui-1.3.3/jquery.min.js"></script>
<script type="text/javascript" src="../ziyuan/jquery-easyui-1.3.3/jquery.easyui.min.js"></script>
<script type="text/javascript" src="../ziyuan/jquery-easyui-1.3.3/locale/easyui-lang-zh_CN.js"></script>
<script type="text/javascript" src="../ziyuan/js2/common.js"></script>
...
<body style="margin:1px;">
	...
	<div id="dlg" class="easyui-dialog" style="width: 700px;height:400px;padding: 0px 20px"
	...
	<div>
	 	<form id="fm" method="post">
	 		<table cellspacing="8px"  cellpadding="8px" >
	 			...
	 			<tr>
	 				<td>联系人：</td>
	 				<td><input type="text" id="linkMan" name="linkMan"  style="border: 1px solid black;" /></td>
	 				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	 				<td>联系电话：</td>
